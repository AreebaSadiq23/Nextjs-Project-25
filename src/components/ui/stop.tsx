...
export default function StopWatch() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: 'url("/img stop-watch.jpg")',
    ...
    >
      <Card className="w-full max-w-lg">
        <CardHeader className="flex flex-col items-center justify-center">
          <CardTitle className="text-5xl font-bold text-red-400">
            Stopwatch
          </CardTitle>
        ...
        <CardContent className="flex flex-col items-center justify-center gap-8 p-4">
          ...
          <div className="flex gap-4">
            <Button
              ...
              className="px-6 py-2 text-lg font-medium rounded-lg bg-red-400"
            >
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="max-h-[300px] overflow-auto p-0">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="text-left text-neutral-950">
                        Lap
                      </TableHead>
                      <TableHead className="text-right  text-neutral-950">
                        Time
                      </TableHead>
                    </TableRow>
                  </TableHeader>
